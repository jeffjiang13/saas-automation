    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic to-neutral-100 dark:from-neutral-500 via-transparent dark:to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic dark:from-transparent via-transparent to-neutral-100 dark:to-neutral-500 text-white [--conic-position:from_290deg_at_center_top]"
        >
